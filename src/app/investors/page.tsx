...
const inputClass =
  "w-full h-14 px-5 rounded-xl text-sm font-medium outline-none border-2 transition-all duration-200 focus:ring-0";
                    ...
                    >
                      ...
                      <div className="space-y-1.5">
                        ...
                        <textarea
                          ...
                          className="w-full px-5 py-4 rounded-xl text-sm font-medium outline-none border-2 resize-none transition-all duration-200"
                          style={getInputStyle()}
                        />
                      </div>

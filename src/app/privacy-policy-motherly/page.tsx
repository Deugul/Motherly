            ...
            <div className="policy-content space-y-6">
              ...
              <section className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Website</strong> refers to Motherly: Your Birth Companion, accessible from <a href="https://beige-swallow-278886.hostingersite.com/" className="underline" style={{ color: "var(--color-primary)" }}>https://beige-swallow-278886.hostingersite.com/</a>.</li>
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  Google: <a href="https://www.google.com/intl/en/policies/privacy/" className="underline" style={{ color: "var(--color-primary)" }}>https://www.google.com/intl/en/policies/privacy/</a>
                </p>
              </section>

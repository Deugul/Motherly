  ...
  return (
    <>
      ...
      >
        ...
        {/* CTA — directly after the cards, for visitors who have already picked
            a service and should not have to scroll to the foot of the page. */}
        <ScrollReveal>
          <div className="flex justify-center mt-14">
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-2 rounded-xl px-8 py-3.5 text-base font-bold transition-transform hover:scale-[1.03]"
              style={{
                fontFamily: "var(--font-headline)",
